...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <!-- Area Chart Example-->
      <div>
      <a class="btn btn-info" href="<?php echo base_url('barang/add'); ?>">Add(+)</a>
      <br><br>
      <table class="table table-striped table-bordered table-hover" id="datatables">
        ...
        <?php foreach ($Barang as $key => $value): ?>
          <tr>
            ...
            <td align="center">
              <a title="Edit Data" href="<?php echo base_url('barang/edit/'.$value->id); ?>"><i class="fa fa-pencil"></i></a>
              &nbsp;
    ...
    <script src="<?php echo base_url('asset/')?>dataTables/database.min.js"></script>
