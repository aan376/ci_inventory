...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <!-- Area Chart Example-->
      <div>
      <a class="btn btn-info" href="<?php echo base_url('divisi/add'); ?>">Add(+)</a>
      <br><br>
      <table class="table table-striped table-bordered table-hover">
        ...
        <?php foreach ($inventory as $key => $value): ?>
          <tr>
            ...
            <td align="center">
              <a title="Edit Data" href="<?php echo base_url('divisi/edit/'.$value->id); ?>"><i class="fa fa-pencil"></i></a>
              &nbsp;
              <a href="<?php echo base_url('divisi/delete/'.$value->id); ?>" onclick="return confirm('Apakah anda ingin menghapus data ini?')" title="Hapus Data" href=""><i class="fa fa-trash"></i></a>
            </td>
          </tr>
        <?php endforeach ?>
